...
import { Mail, Phone, MapPin } from "lucide-react";import { siteConfig, mainNav } from "@/lib/data";
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-brand-200">{siteConfig.phone}</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-accent-400 flex-shrink-0" />
                <a href={`mailto:${siteConfig.email}`} className="text-brand-200 hover:text-accent-400 transition">
                  {siteConfig.email}
                </a>
              </li>
            </ul>
