...
export default function HoldingOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center px-6 bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <span className="text-xs uppercase tracking-widest hidden sm:inline">Ver sitio</span>
        <div className="w-9 h-9 rounded-full border border-white/10 group-hover:border-white/30 flex items-center justify-center transition-colors">
          <X size={16} />
        </div>
      </button>
      ...
      <div className="relative z-10 max-w-xl w-full text-center space-y-10">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="tel:5667530599"
              className="flex items-center gap-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-semibold px-6 py-3 rounded-full transition-all duration-200 text-sm w-full sm:w-auto justify-center"
            >
